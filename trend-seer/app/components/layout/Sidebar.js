...
export default function Sidebar({isOpen, onClose}) {
      ...
      const navItems = [
        ...
        { to: '/insights', icon: <BarChart3 size={20} />, label: 'Market Insights' },
        { to: '/alerts', icon: <Bell size={20} />, label: 'Price Alerts' },
        { to: '/compare', icon: <Layers size={20} />, label: 'Compare Properties' },
      ];
